...
if "social_django.context_processors.backends" not in _context_processors:
    _context_processors.append("social_django.context_processors.backends")

if "social_django.context_processors.login_redirect" not in _context_processors:
    _context_processors.append("social_django.context_processors.login_redirect")
